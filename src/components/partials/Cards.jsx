...
// console.log(data); 
  return (
    <div className='flex flex-wrap h-full w-full align-center justify-center px-[5%] bg-[#1F1E24]'>
      {data.map((c,i) => (
         <Link to={`/${c.media_type || title}/details/${c.id}`}
              className='relative w-[25vh] mr-[5%] mb-[5%]'
              key={i}
         >
            <img className='shadow-[8px_17p_38px_2px_rgba(0,0,0,.5)] h-[40vh] object-cover' 
            src={                 
