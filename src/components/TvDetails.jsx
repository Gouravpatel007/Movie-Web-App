       ...
       className='relative w-screen h-[192vh] px-[10%]'>
         ...
         {/* Part-1 navigation */}
          <nav className='h-[10vh] w-full text-zinc-100 flex items-center gap-16 text-2xl'>
                ...
                <a  target='_blank' href={`https://www.imdb.com/title/${info.externalid.imdb}/`}>
                  imdb
                </a>
          </nav>
         ...
         <div className='w-full flex '>
           <img className='shadow-[8px_17p_38px_2px_rgba(0,0,0,.5)] h-[50vh] object-cover' 
               src={
            ...
            alt="" />
              ...
              <div className='content ml-[5%] text-white'>
                ...
                <h1 className='mb-3 text-2xl mt-5'>
                     Overview
                </h1>
         ...
         <hr className='mt-10 mb-5 border-none h-[2px] bg-zinc-500'/>
           ...
           <div className='w-[100%] flex overflow-y-hidden mb-5 p-5'>
              {info.detail.seasons.length > 0 ? info.detail.seasons.map((s,i)=> (
                 <div className='w-[14vh] mr-[10%]'>
                    <img 
                       className='min-w-[14vw] shadow-[8px_17p_38px_2px_rgba(0,0,0,.5)] h-[39vh] object-cover' 
                        src={
                       `https://image.tmdb.org/t/p/original/${
                        s.poster_path
                       }` 
